      ...
      <CardContent className="pt-6">
        <div className="space-y-4">
          ...
          {fields.map((field, index) => (
            <div
              key={field.id}
              className="border rounded p-4 space-y-4 relative"
            >
              <div className="flex justify-between items-center">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <Label htmlFor={`drying.${index}.temperature`}>
                    Temperature (°C)
                  </Label>
                  <Input
                    type="number"
                ...
                <div>
                  <Label htmlFor={`drying.${index}.humidity`}>
                    Humidity (%)
                  </Label>
                  <Input
                    type="number"
                ...
                <div>
                  <Label htmlFor={`drying.${index}.moistureQuantity`}>
                    Moisture Quantity (%)
                  </Label>
                  <Input
                    type="number"
