...
export function BankDetailsSection() {
	...
	const handleIFSCChange = async (ifscCode: string) => {
		...
		try {
			...
			setValue('bankDetails.branchName', data.BRANCH || '', { shouldValidate: true });
			setValue('bankDetails.address', data.ADDRESS || '', { shouldValidate: true });
			setValue('bankDetails.bankName', data.BANK || '', { shouldValidate: true });
			setValue('bankDetails.bankCode', data.BANKCODE || '', { shouldValidate: true });
		} catch (error) {
