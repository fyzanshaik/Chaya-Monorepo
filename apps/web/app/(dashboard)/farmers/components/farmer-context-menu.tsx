...
import { ContextMenu, ContextMenuContent, ContextMenuItem, ContextMenuSeparator, ContextMenuTrigger } from '@workspace/ui/components/context-menu';
import {
	AlertDialog,
	AlertDialogAction,
	AlertDialogCancel,
			...
			<AlertDialog open={showDeleteDialog} onOpenChange={setShowDeleteDialog}>
				<AlertDialogContent>
					<AlertDialogHeader>
						...
						<AlertDialogDescription>This action cannot be undone. This will permanently delete the farmer record and all associated data.</AlertDialogDescription>
					</AlertDialogHeader>
					<AlertDialogFooter>
